...
#### Small core
The node.js core is build on the principle of having the smallest set of functionality and leave the rest to the "userland", the ecosystem of independent modules provided by the node platform developers. Instead of relying on a big and slowly evolving core the features are often developed around the tight and stable core by open source developers. The core is hold to a bare minimum.
